...
public class SplashScreen extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/com/sistema/main/InvTrackAdobe-removebg-preview (1).png"))); // NOI18N
    ...
    new Thread(new Runnable() {
        ...
        public void run() {
            try {
                doTask("Conectando ao Banco de Dados...", 10);
                doTask("Carregando Configurações...", 30);
                doTask("Iniciando Sistema...", 50);
                doTask("Carregando Módulos...", 70);
                doTask("Finalizando...", 90);
                doTask("Concluído!", 100);
                dispose();
